...
def get_mac_address():
    """Get MAC address from the first non-loopback network interface."""
...
def output_csv(data):
    ...
    with open("sysinfo.csv", "w", newline="", encoding="utf-8") as csvfile:
...
def output_json(data):
    ...
    with open("sysinfo.json", "w", encoding="utf-8") as jsonfile:
